...
public class LayoutManager {
    public static func layoutClassForString(_ layoutString: String) -> Layout.Type? {
        switch layoutString {
        case "tall":
    ...
    public static func stringForLayoutClass(_ layoutClass: Layout.Type) -> String {
    ...
    public static func layoutsWithConfiguration(_ userConfiguration: UserConfiguration, windowActivityCache: WindowActivityCache) -> [Layout] {
