...
public class BinarySpacePartitioningLayout: Layout {
    private class BinarySpacePartitioningReflowOperation: ReflowOperation {
        ...
        public init(screen: NSScreen, windows: [SIWindow], rootNode: TreeNode, windowActivityCache: WindowActivityCache) {
    ...
    override public static var layoutName: String { return "Binary Space Partitioning" }
    override public static var layoutKey: String { return "bsp" }

    internal var rootNode = TreeNode()
    internal var lastKnownFocusedWindowID: CGWindowID?

    public override func reflowOperationForScreen(_ screen: NSScreen, withWindows windows: [SIWindow]) -> ReflowOperation {
    ...
    public override func updateWithChange(_ windowChange: WindowChange) {
        switch windowChange {
        case let .add(window):
